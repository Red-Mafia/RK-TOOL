...
def logo():
    ...
    os.system('echo -e "\n\n    \n ██████╗ ██╗ █████╗ ███████╗   \n ██╔══██╗██║██╔══██╗╚══███╔╝   \n ██████╔╝██║███████║  ███╔╝       \n ██╔══██╗██║██╔══██║ ███╔╝    \n ██║  ██║██║██║  ██║███████╗   \n  ╚═╝  ╚═╝╚═╝╚═╝  ╚═╝╚══════╝ \n-----------------------------------------------\n\n\xe2\x9e\xa3 Edit By   : RIAZKHAN \n\xe2\x9e\xa3 Facebook  : RIAZKHAN\n\xe2\x9e\xa3 Github    : https://github.com/Red-Mafia\n\xe2\x9e\xa3 Whatsapp  : +923188******\n\n-----------------------------------------------" | lolcat -a -d 2 -s 50')
...
def main():
    ...
    print '\x1b[97;1m  [0] Team Red-Mafia '
